  ...
  return (
    <div>
      ...
      <ul style={{ listStyleType: "none", padding: 0 }}>
        ...
        <li>
          Seid ihr euch sicher, dass ihr dieses gefährliche Spiel spielen wollt,
          so klickt auf den "Start" Button!
        </li>
        <li>
        ...
        <li>
          Um einen neuen Spieler hinzuzufügen, klickt jeweils auf den "+" Button
          und tragt eure Namen ein!
        </li>
        <li>
        ...
        <li>
          Gut für Nicht-Trinker: Ihr dürft gern dennoch die Kategorien wählen,
          in denen getrunken wird. Hier bekommt ihr allerdings Aufgaben, die ihr
          lösen müsst, um Schlücke an Mitspieler zu verteilen!
        </li>
        <li>
          Erfüllt dann die Anforderungen der Aufgabe und klickt auf den "Aufgabe
          gemeistert" Button, wenn ihr damit fertig seid.
        </li>
        <li>
        ...
        <li>
          Nach genau 30 Aufgaben ist das Spiel beendet und ihr seid vermutlich
          betrunkener als vorher!
        </li>
      </ul>
